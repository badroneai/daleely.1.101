...
export const tools: Tool[] = [
  ...
  },
  {
    slug: "measurement",
    title: "وحدات القياس",
    description: "تدرّب على تحويل وحدات الطول والكتلة والسعة في المنظومة المترية بتمارين تفاعلية",
    category: "math",
    gradeLevel: "all",
    keywords: ["وحدات القياس", "المنظومة المترية", "الطول", "الكتلة", "السعة", "التحويل"],
    visibility: toolVisibilityRules["measurement"],
    scopeByGrade: createScopeByGrade("measurement"),
  },
  {
    slug: "perimeter-area-volume",
    title: "المحيط والمساحة والحجم",
    description: "احسب محيط المستطيل ومساحته وحجم المنشور بتمارين تفاعلية متدرّجة",
    category: "math",
    gradeLevel: "all",
    keywords: ["المحيط", "المساحة", "الحجم", "المستطيل", "المنشور"],
    visibility: toolVisibilityRules["perimeter-area-volume"],
    scopeByGrade: createScopeByGrade("perimeter-area-volume"),
  },
  {
    slug: "algebra",
    title: "العبارات والمعادلات",
    description: "تدرّب على تقييم العبارات الجبرية وترتيب العمليات وحل المعادلات البسيطة",
    category: "math",
    gradeLevel: "all",
    keywords: ["الجبر", "العبارات الجبرية", "المعادلات", "ترتيب العمليات", "المتغيّر"],
    visibility: toolVisibilityRules["algebra"],
    scopeByGrade: createScopeByGrade("algebra"),
  },
  {
    slug: "statistics",
    title: "الإحصاء والاحتمال",
    description: "تدرّب على المتوسط الحسابي والوسيط والاحتمال بتمارين تفاعلية",
    category: "math",
    gradeLevel: "all",
    keywords: ["الإحصاء", "المتوسط الحسابي", "الوسيط", "الاحتمال", "البيانات"],
    visibility: toolVisibilityRules["statistics"],
    scopeByGrade: createScopeByGrade("statistics"),
  },
  {
    slug: "geometry",
    title: "الهندسة",
    description: "تعرّف على الأشكال الرباعية والزوايا والمستوى الإحداثي بتمارين تفاعلية",
    category: "math",
    gradeLevel: "all",
    keywords: ["الهندسة", "الأشكال الرباعية", "الزوايا", "المستوى الإحداثي", "الإحداثيات"],
    visibility: toolVisibilityRules["geometry"],
    scopeByGrade: createScopeByGrade("geometry"),
  },
  {
    slug: "arabic-letters",
