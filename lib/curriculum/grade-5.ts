...
export const grade5: GradeCurriculum = {
  ...
  subjects: [
    ...
    },
    {
      ...
      units: [
        { title: "الوحدة الأولى: تنوُّع الحياة", lessons: [{ title: "تصنيف المخلوقات الحية", productType: "interactive", activityId: "sci-classify-living-sort" }, { title: "النباتات", productType: "interactive", activityId: "sci-plant-parts-label" }, "تكاثر البكتيريا", { title: "دورات الحياة", productType: "interactive", activityId: "sci-life-cycle-sequence" }] },
        { title: "الوحدة الثانية: الأنظمة البيئية", lessons: [{ title: "العلاقات في الأنظمة البيئية", productType: "interactive", activityId: "sci-ecosystem-match" }, "التكيُّف والبقاء", "الدورات في الأنظمة البيئية", "التغيرات في الأنظمة البيئية"] },
        ...
        { title: "الوحدة الخامسة: المادة", lessons: [{ title: "العناصر", productType: "interactive", activityId: "sci-elements-sort" }, "المخاليط والفلزّات واللافلزّات", { title: "تغيرات حالة المادة", productType: "interactive", activityId: "sci-matter-states-sort" }, "المركبات والتغيرات الكيميائية"] },
        { title: "الوحدة السادسة: القوى والطاقة", lessons: ["الشغل والطاقة", { title: "الآلات البسيطة", productType: "interactive", activityId: "sci-simple-machines-quiz" }, "الصوت", "الضوء"] },
      ],
    },
    {
      id: "arabic",
      ...
      units: [
        {
          ...
          lessons: [
            ...
            { title: "الصنف اللغوي: أنواع الجموع", productType: "interactive", activityId: "arabic-jamc-sort" },
            { title: "الظاهرة الإملائية: الهمزة المتوسطة على الألف", productType: "interactive", activityId: "arabic-hamza-quiz" },
    ...
    },
    {
      ...
      defaultProductType: "lesson",
      units: [
        { title: "الوحدة الأولى: الخلفاء الراشدون", lessons: [{ title: "الخليفة أبو بكر الصديق", productType: "interactive", activityId: "social-caliphs-sequence" }, "الخليفة عمر بن الخطاب", "الخليفة عثمان بن عفان", { title: "الخليفة علي بن أبي طالب", productType: "interactive", activityId: "social-caliphs-match" }] },
        { title: "الوحدة الثانية: التاريخ الإسلامي", lessons: [{ title: "الدولة الأموية", productType: "interactive", activityId: "social-states-match" }, "الدولة العباسية", "الحضارة الإسلامية"] },
        { title: "الوحدة الثالثة: الأمن الوطني", lessons: ["الأمن", "أجهزة الأمن"] },
        { title: "الوحدة الرابعة: جغرافية المملكة العربية السعودية", lessons: ["الموقع والحدود", { title: "مظاهر السطح", productType: "interactive", activityId: "social-landforms-match" }, "الأودية", "المنطقة الساحلية والجُزُر", "المناطق الإدارية"] },
      ],
    },
    {
      id: "life-skills",
      ...
      defaultProductType: "lesson",
      units: [
        { title: "الوحدة الأولى: صحتي وسلامتي", lessons: ["العلامات الحيوية في الجسم (درجة الحرارة - النبض)", { title: "التعامل مع الأدوية", productType: "interactive", activityId: "life-medicine-quiz" }] },
        ...
        { title: "الوحدة الخامسة: غذائي", lessons: [{ title: "العناصر الغذائية", productType: "interactive", activityId: "life-nutrition-sort" }, "البيض"] },
      ],
    },
    {
      id: "art",
      ...
      defaultProductType: "lesson",
      units: [
        { title: "الوحدة الأولى: مجال الرسم", lessons: [{ title: "الخامات المختلفة والمنظور والنسب", productType: "interactive", activityId: "art-terms-match" }, "المآذن والقبب في العمارة الإسلامية", "الحرف الشعبية"] },
