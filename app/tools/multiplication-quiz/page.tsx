...
const faq = [
  {
    ...
    answer:
      "يحتوي الاختبار على 10 أسئلة تجمع بين الضرب والقسمة وعائلات الحقائق المترابطة. يمكنك إعادة الاختبار عدة مرات كما تشاء، وفي النهاية تظهر نتيجتك ومراجعة لأخطائك.",
  },
  {
...
export default async function MultiplicationQuizPage({ searchParams }: PageProps) {
