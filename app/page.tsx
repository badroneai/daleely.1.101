  ...
  return (
    <PageLayout>
      ...
      <div className="grid md:grid-cols-4 gap-6 mt-12">
        <Link href="/math" className="card text-center hover:border-primary-300 transition-colors">
          <div className="text-4xl mb-4">🔢</div>
          <h2 className="text-xl font-bold mb-2">رياضيات</h2>
          <p className="text-gray-600">جدول الضرب، الجمع، الطرح، وأكثر</p>
        </Link>
        
        <Link href="/arabic" className="card text-center hover:border-primary-300 transition-colors">
          <div className="text-4xl mb-4">📚</div>
          <h2 className="text-xl font-bold mb-2">عربي</h2>
          <p className="text-gray-600">الحروف، الأصوات، الحركات</p>
        </Link>
        
        <Link href="/teachers" className="card text-center hover:border-primary-300 transition-colors">
          <div className="text-4xl mb-4">👩‍🏫</div>
          <h2 className="text-xl font-bold mb-2">للمعلمين</h2>
          <p className="text-gray-600">مولّد أوراق العمل والأنشطة</p>
        </Link>
        
        <Link href="/parents" className="card text-center hover:border-primary-300 transition-colors">
          <div className="text-4xl mb-4">👨‍👩‍👧‍👦</div>
